              ...
              <div class="color-group">
                <div class="color-row">
                  ...
                  <div
                    ...
                    :title="`${currentTag.textColor} @ ${currentTag.textOpacity}%`"
                  />
              ...
              <div class="color-group">
                <div class="color-row">
                  ...
                  <div
                    ...
                    :title="`${currentTag.bgColor} @ ${currentTag.bgOpacity}%`"
                  />
...
function onTypeChange() {
  ...
  // Reset to sensible defaults on type change
